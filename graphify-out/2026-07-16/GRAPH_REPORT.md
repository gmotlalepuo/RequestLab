...
## Corpus Check
- 63 files · ~188,469 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 426 nodes · 822 edges · 18 communities (14 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fe8bf72`
...
- `WorkspacePage()` --calls--> `createClient()`  [EXTRACTED]
  app/app/page.tsx → lib/supabase/server.ts
...
Cohesion: 0.05
Nodes (65): App(), Stack, theme, usePortalShellOnWeb(), react, react, ActionSheetOption, Props (+57 more)

### Community 1 - "Repository"
Cohesion: 0.07
Nodes (9): KEYS, LocalRepository, writeAll(), Repository, ApiRequest, Collection, Folder, Workspace (+1 more)

### Community 2 - "ApiClient.tsx"
Cohesion: 0.09
Nodes (19): ChooseAppPage(), SettingsPage(), AdminPortal(), AdminUser, Complaint, Direction, PAGE_SIZES, text() (+11 more)

### Community 3 - "SupabaseRepository"
Cohesion: 0.07
Nodes (18): CollectionRow, EnvironmentRow, FolderRow, RequestRow, SupabaseRepository, toCollection(), toEnvironment(), toFolder() (+10 more)
...
Cohesion: 0.06
Nodes (39): ApiClient(), BodyEditor(), CollectionTreeNode(), createCurl(), emptyRequest(), EnvironmentManager(), FolderTreeNode(), jsonTokens() (+31 more)

### Community 9 - "route.ts"
Cohesion: 0.18
Nodes (17): AdminPage(), DELETE(), GET(), PATCH(), POST(), currentUser(), GET(), PATCH() (+9 more)
...
## Knowledge Gaps
- **130 isolated node(s):** `Stack`, `theme`, `name`, `slug`, `version` (+125 more)
...
- **Why does `react` connect `CollectionScreen.tsx` to `package.json`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `dependencies` connect `package.json` to `CollectionScreen.tsx`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `Repository` connect `Repository` to `postman.ts`, `SupabaseRepository`?**
